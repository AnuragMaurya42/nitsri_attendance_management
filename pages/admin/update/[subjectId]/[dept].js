...
const UpdateSubject = () => {
  ...
  const updateCourseDetails = async () => {
    ...
    const data = await res.json();
    if (data.Success) {
      toast.success("Course updated successfully", toastConfig);
      setCourseDetails({
        ...courseDetails,
      ...
      toast.error("Failed to update course", toastConfig);
    }
  };
  ...
  const assignNewFaculty = async () => {
    ...
    if (data.Success) {
      ...
      toast.error("Failed to assign faculty", toastConfig);
    }
  };
  ...
  return (
    <div className="h-screen bg-gray-900 text-gray-100 flex justify-center items-start overflow-hidden">
      <ToastContainer />

      <div className="flex flex-col w-full max-w-md h-full overflow-hidden pt-4">
            ...
            <>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="flex justify-center mt-4">
                  <Link
                    href={`/faculty/showSummary/${courseDetails.courseCode}`}
                  >
                    <button className="w-auto py-2 px-3 rounded-lg text-center bg-orange-500 text-white">
                      View Attendance
                    </button>
                  </Link>
                </div>
              ...
              <div className="flex flex-col gap-4">
                <button
                  ...
                  className="w-full px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl shadow-md"
                >
                  Update Course
                </button>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-md"
                >
                  Choose New Faculty
                </button>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold rounded-xl shadow-md"
                >
                  Select Students
                </button>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-pink-500 hover:bg-pink-600 text-white font-semibold rounded-xl shadow-md"
                >
                  View Students
                </button>
              </div>
