  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <div
          className="w-full max-w-xs p-6 rounded-lg shadow-md"
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            {/* Name Input */}
            <div className="mb-4">
              <label htmlFor="name" className="block text-lg text-white font-medium b-2">
                Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label
                ...
                className="block text-lg text-lg text-white font-medium mb-2"
              >
                Confirm Password
              </label>
              <input
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 text-lg font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
              Sign Up
            </button>
          </form>
